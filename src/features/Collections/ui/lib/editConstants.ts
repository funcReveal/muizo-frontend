...
export const EDIT_VOLUME_STORAGE_KEY = "edit_volume";
export const LEGACY_VOLUME_STORAGE_KEY = "volume";
export const EDIT_MUTE_STORAGE_KEY = "edit_muted";
export const EDIT_AUTOPLAY_STORAGE_KEY = "edit_autoplay";
export const EDIT_LOOP_STORAGE_KEY = "edit_loop";
